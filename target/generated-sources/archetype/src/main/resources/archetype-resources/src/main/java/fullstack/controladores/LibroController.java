...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.fullstack.controladores;


import ${package}.fullstack.config.PageResponse;
import ${package}.fullstack.dtos.LibroRequestDTO;
import ${package}.fullstack.dtos.LibroResponseDTO;
import ${package}.fullstack.mappers.LibroMapper;
import ${package}.fullstack.servicios.ILibroService;
