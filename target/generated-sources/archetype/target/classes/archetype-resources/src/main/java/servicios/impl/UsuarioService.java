...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.servicios.impl;

import ${package}.entidades.Rol;
import ${package}.entidades.Usuario;
import ${package}.exceptions.BusinessRuleException;
import ${package}.exceptions.UsuarioNotFoundException;
import ${package}.repositorio.RolRepository;
import ${package}.repositorio.UsuarioRepository;
import ${package}.servicios.IUsuarioService;
